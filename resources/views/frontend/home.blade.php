      ...
      <div class="carousel-item @if ($loop->first) active @endif">
        ...
        <div class="view">
            ...
            <video class="video-fluid" autoplay loop muted width="100%">
                <source src="{{asset($slide->image_path)}}" width="100%"/>
            </video>
            @endif

            @if($slide->type == 'Image')
            <div class="view">
                <img src="{{asset($slide->image_path)}}" width="100%">
...
<!-- START SECTION ABOUT -->
<section class="small_pt small_pb overflow-hidden " style="background: #28A575">
        	...
        	<div class="col-md-6">
            	<div class="box_shadow1 bg-white overlap_section padding_eight_all">
                	<div class="animation" data-animation="fadeInLeft" data-animation-delay="0.02s">
                        ...
                        <p>KC Constructions is owned by the KC group of Companies, a conglomerate involved in the manufacture of food, hydropower, insurance, education , Construction and banking sector. KC group established Himshree Foods in 1981.

Additionally, in 1998, KC Group also founded Machhapuchchhre Bank, the first commercial bank of Nepal based in the western region of the country. Almost two decades later, the group further entered the insurance business in 2017 having major stake of Sun Nepal Life Insurance.Starting from 2005, KC Group has made extensive investments in the hydropower sector.</p>
        	...
        	<div class="col-md-6">
            	<div class="animation" data-animation="fadeInRight" data-animation-delay="0.03s">
                	<div class="overlay_bg_30 about_img z_index_minus1">	
                    	<img class="w-100" src="{{asset('assets/images/aboutus.jpg')}}" alt="about_img"/>
                    </div>
        ...
        <section class="bg_gray sectorsclass">
            <div class="report">
                <div class="container">
                    ...
                    <div class="row sectorslider pl-5 pr-5">
                        <div class="col-12 animation">
              ...
              <div class="row">
                  <div class="col-md-12 text-center">
                      <ul class="list_none grid_filter">
                          ...
                          <li><a href="#" data-filter=".Hydropower">Hydropower</a></li>
              ...
              <div class="row">
                  <div class="col-md-12">
                      <ul class="grid_container gutter_medium grid_col3">
                          ...
                          @foreach ($hydropower as $projectsData)
                          <li class="grid_item Hydropower">
                          ...
                          <li class="grid-sizer"></li>
                          <!-- START PORTFOLIO ITEM -->
                          @foreach ($construction as $projectsData)
                          <li class="grid_item Construction">
                              <div class="gallery_item">
